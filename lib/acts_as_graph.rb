      ...
      module Graph # :nodoc:
        ...
        module ClassMethods
          def acts_as_graph(options = {})
            ...
            class_eval <<-EOV
              include BuildPatterns::ActiveRecord::Acts::Graph::InstanceMethods
...
ActiveRecord::Base.send :include, BuildPatterns::ActiveRecord::Acts::Graph